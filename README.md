...
```
cd existing_repo
git remote add origin https://gitlab.com/yusuferturk/beslenme.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/yusuferturk/beslenme/-/settings/integrations)
